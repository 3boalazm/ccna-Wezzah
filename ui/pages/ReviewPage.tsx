...
const S: Record<string, React.CSSProperties> = {
  ...
  statCard: { flex: "1 1 120px", background: "#fff", border: "1px solid var(--border, #E3E2DC)", borderRadius: 12, padding: "16px", textAlign: "center" },
  ...
  upcomingRow: { display: "flex", alignItems: "center", gap: 10, padding: "9px 12px", borderRadius: 8, background: "#fff", border: "1px solid var(--border, #E3E2DC)", fontSize: 13 },
  ...
  signalRow: { display: "flex", alignItems: "center", gap: 10, padding: "9px 12px", borderRadius: 8, background: "#fff", border: "1px solid var(--border, #E3E2DC)", fontSize: 13 },
  ...
  refreshBtn: { padding: "8px 16px", borderRadius: 999, border: "1px solid var(--border, #E3E2DC)", background: "#fff", fontSize: 12.5, fontWeight: 600, cursor: "pointer" },
