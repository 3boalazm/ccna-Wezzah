...
const S: Record<string, React.CSSProperties> = {
  ...
  option: { display: "block", width: "100%", textAlign: "left", padding: "11px 14px", marginBottom: 8, border: "1px solid var(--border, #E3E2DC)", borderRadius: 8, background: "#fff", fontSize: 14, cursor: "pointer", color: "var(--text-primary)" },
