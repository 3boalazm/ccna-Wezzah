...
const S: Record<string, React.CSSProperties> = {
  ...
  scenarioCard: { textAlign: "left", padding: "16px 18px", borderRadius: 12, border: "1px solid var(--border, #E3E2DC)", background: "#fff", cursor: "pointer" },
  ...
  backBtn: { padding: "6px 14px", border: "1px solid var(--border, #E3E2DC)", borderRadius: 999, background: "#fff", fontSize: 12.5, fontWeight: 600, cursor: "pointer", marginBottom: 16 },
  card: { background: "#fff", border: "1px solid var(--border, #E3E2DC)", borderRadius: 12, padding: "22px 24px" },
